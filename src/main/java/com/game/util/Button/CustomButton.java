...
import com.game.util.Sounds.SoundPlayer.SoundEffects;
    ...
    public void draw(Graphics2D g2) {
        ...
        if (visible) {
            ...
            if (image == null) {
                ...
                } else if ((selectedButtons.contains(index) || otherSelectedButtons.contains(index))
                        && (drawOnSelect != null)) {
